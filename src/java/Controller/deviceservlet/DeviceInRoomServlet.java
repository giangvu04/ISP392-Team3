...
public class DeviceInRoomServlet extends HttpServlet {
    ...
    private void listDevicesInRooms(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Lấy danh sách thiết bị trong phòng theo trang
            ArrayList<DeviceInRoom> devicesInRooms = deviceInRoomDAO.getDevicesInRoomsByPage(page, DEVICES_PER_PAGE);
            int totalDevices = deviceInRoomDAO.getTotalDevicesInRooms();
    ...
    private void searchDevicesInRooms(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<DeviceInRoom> devicesInRooms = deviceInRoomDAO.searchDevicesInRooms(keyword.trim());
    ...
    private void removeDeviceFromRoom(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int deviceId = Integer.parseInt(deviceIdStr);
             ...
             try {
                deviceInRoomDAO.removeDeviceFromRoom(roomId, deviceId);
