        ...
        <style>
            * {
            ...
            .btn-secondary {
                background: #6c757d;
                color: white;
                box-shadow: 0 412px 15px rgba(108, 117, 125, 0.3);
            }
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <div class="subtitle">Gán thiết bị cho phòng cụ thể với trạng thái</div>
            </div>
                ...
                <form action="deviceinroom" method="post" id="addDeviceToRoomForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select style="width: 620px; border-radius: 10px; padding: 10px" class="form-select" id="roomId" name="roomId" required>
                                <option value="" disabled selected>Chọn phòng</option>
                                <c:forEach var="room" items="${rooms}">
                                    <i class="fas fa-door-open"></i><option value="${room.roomId}" <c:if test="${room.roomId == preselectedRoomId}">selected</c:if>>
                                        Phòng - ${room.roomNumber} - Khu ${room.retalArea.name}
                                    </option>
                                </c:forEach>
                            </select>
                        </div>
