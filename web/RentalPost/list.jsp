                                                ...
                                                <div class="card-actions">
                                                    <div class="d-grid gap-1">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            <a href="${pageContext.request.contextPath}/roomDetail?id=${post.postId}" class="btn btn-outline-primary btn-sm flex-fill">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <form method="post" action="${pageContext.request.contextPath}/toggleStatus" class="flex-fill">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${userRole == 1}">
                                                                    <form method="post" action="${pageContext.request.contextPath}/deletePost?postId=${post.postId}" class="flex-fill">
                                                                        <input type="hidden" name="postId" value="${post.postId}">
                                                                        <button type="submit" class="btn ${post.featured ? 'btn-danger' : 'btn-outline-danger'} btn-sm w-100"
