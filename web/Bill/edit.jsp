    ...
    <body>
                            ...
                            <div class="form-card">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="rentalArea" class="form-label">Khu trọ</label>
                                            <select class="form-select" id="rentalArea" name="rentalArea" onchange="loadRoomsByAreaForEdit()" disabled>
                                                <option value="">Khu trọ hiện tại</option>
                                                <c:forEach var="area" items="${rentalAreas}">
                                                    <option value="${area.rentalAreaId}">${area.name}</option>
                                                </c:forEach>
                                            </select>
                                            <small class="text-muted">Không thể thay đổi khu trọ khi chỉnh sửa</small>
                                        </div>
                                        <div class="mb-3">
                                            <label for="tenantName" class="form-label">Tên người thuê <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="tenantName" name="tenantName" value="${bill.tenantName}" readonly="" required placeholder="Nhập tên người thuê">
                                        </div>
                                        <div class="mb-3">
                                            <label for="roomNumber" class="form-label">Số phòng <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="roomNumber" name="roomNumber" value="${bill.roomNumber}" readonly="" required placeholder="Ví dụ: A101">
                                        </div>
                                        <div class="mb-3">
                            ...
                            <div class="form-card">
                                ...
                                <div class="cost-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-end">
                                            <input type="number" class="form-control cost-input" id="roomCost" name="roomCost" value="${bill.roomCost}" min="0" step="1000" onchange="calculateTotal()">
                                        </div>
                                    </div>
                                </div>
                                <div class="cost-item">
                                ...
                                <div class="cost-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-end">
                                            <input type="number" class="form-control cost-input" id="otherServiceCost" name="otherServiceCost" value="${bill.otherServiceCost}" min="0" step="1000" onchange="calculateTotal()">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
                                                ...
                                                function calculateTotal() {
                                                    ...
                                                    const total = roomCost + electricity + water + service + otherService;
                                                    document.getElementById('totalAmount').textContent = total.toLocaleString('vi-VN') + ' ₫';
                                                }

                                                // Load phòng theo khu trọ cho edit (chỉ để tham khảo, không cho phép thay đổi)
                                                function loadRoomsByAreaForEdit() {
                                                    // Chức năng này có thể để trống vì không cho phép thay đổi khu trọ trong edit
                                                    console.log('Edit mode - không cho phép thay đổi khu trọ');
                                                }
