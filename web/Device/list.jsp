...
<body>
    <div class="container-fluid">
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h2 class="mb-1">Danh sách thiết bị</h2>
                            <p class="text-muted mb-0">Quản lý, tìm kiếm và thao tác với thiết bị trong hệ thống.</p>
                        </div>
                        <div class="text-end">
                            <a class="btn btn-light btn-lg" href="ManagerHomepage">Quay lại</a>
                        </div>
                    </div>
                    <!-- Statistics Cards (customized for device) -->
                    <div class="row mb-4">
                    ...
                    <div class="card">
                        <div class="card-header bg-white">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="${pageContext.request.contextPath}/listdevices?action=add" class="btn btn-gradient">
                                ...
                                <c:when test="${empty devices}">
                                    <div class="text-center py-5">
                                        ...
                                        <c:if test="${not searchMode}">
                                            <a href="${pageContext.request.contextPath}/listdevices?action=add" class="btn btn-gradient mt-3">
                                        ...
                                        <table class="table table-hover mb-0">
                                            <thead class="table-dark">
                                                <tr>
                                                    ...
                                                    <th scope="col"><i class="fas fa-tv me-2"></i>Tên thiết bị</th>
                                                    <th scope="col"><i class="fas fa-tv me-2"></i>Mã máy</th>
                                                    <th scope="col"><i class="fas fa-tv me-2"></i>Ngày mua</th>
                                                    <th scope="col" class="text-center" style="width: 200px;"><i class="fas fa-cogs me-2"></i>Thao tác</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach var="device" items="${devices}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <h6 class="text-muted">${device.deviceCode}</h6>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="align-middle">
                                                            <div class="d-flex align-items-center">
                                                                <div>
                                                                    <h6 class="text-muted">${device.purchaseDate}</h6>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="text-center align-middle">
                                                            <div class="action-buttons">
                                                                <a href="${pageContext.request.contextPath}/listdevices?action=view&id=${device.deviceId}" class="btn btn-sm btn-outline-info" title="Xem chi tiết">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                                                <a href="${pageContext.request.contextPath}/listdevices?action=edit&id=${device.deviceId}" class="btn btn-sm btn-outline-warning" title="Chỉnh sửa">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>
                                                                <button type="button" class="btn btn-sm btn-outline-danger" title="Xóa thiết bị" onclick="confirmDelete(${device.deviceId}, '${device.deviceName}')">
        ...
        <c:if test="${not empty sessionScope.errorMessage}">
            ...
            <c:remove var="errorMessage" scope="session"/>
        <!-- ...existing code... (đã có giao diện mới, phần cũ bị trùng đã được xóa) ... -->
                </small>
            </div>
        </c:if>
    </div>
