            ...
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto px-4 py-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h2 class="mb-1"><i class="fas fa-file-contract me-2"></i>Hợp đồng của tôi</h2>
                            <p class="text-muted mb-0">Xem và quản lý các hợp đồng thuê phòng</p>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-8">
                            <div class="welcome-section bg-white rounded-3 shadow-sm p-4 mb-3">
                        ...
                        <div class="col-md-4">
                            <div style="height: 105px" class="bg-white rounded-3 shadow-sm p-4 mb-3 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <!--                            <i class="fas fa-chart-bar fa-2x text-primary opacity-50 mt-2"></i>-->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="filter-section bg-white rounded-3 shadow-sm p-3">
                                <h6 class="mb-2"><i class="fas fa-filter me-2"></i>Lọc theo trạng thái:</h6>
                                <div>
                        ...
                        <div class="col-md-6">
                            <div style="height: 105px; align-content: center" class="search-box bg-white rounded-3 shadow-sm p-3">
                                <form method="GET" action="${pageContext.request.contextPath}/mycontract" class="mb-0">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text"
                                               ...
                                               value="${keyword}">
                                        <button type="submit" class="btn btn-light btn-lg ms-2">Tìm kiếm
                                                ...
                                                <c:if test="${contract.depositAmount != null && contract.depositAmount > 0}">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="info-item">
                                                                <div class="info-label">
                                                                    <i class="fas fa-piggy-bank me-1"></i>Tiền đặt cọc
                                                                </div>
